...
export async function generateMetadata({params}: PropsParams): Promise<Metadata> {
    try{
        ...
        .catch(() => {
            return{
                title: "DalyGames - Descura jogos incríveis para se divertir."
            }
        })
...
export default async function Game({
    ...
    return(
        <main className="w-full text-black">
           <div className="bg-black h-80 sm:h-96 -full w-full relative">
            <Image 
            ...
            src={data.image_url}
                ...
                <Container>
                    ...
                    <h2 className="font-bold text-lg mt-7">Plataformas</h2>
                    ...
                    <h2 className="font-bold text-lg mt-7">Jogo recomendado:</h2>
                    <div className="flex">
